        ...
        <div class="container">
          ...
          <div class="breadcrumb">
            <div class="breadcrumb-inner">
              ...
              <div class="breadcrumb-item"><span class="breadcrumb-text breadcrumb-active">Artikel</span></div>
            </div>
          </div>
        </div>
      </section>
              ...
              <nav role="navigation">
                <ul class="pagination d-flex justify-content-center flex-wrap pagination-flat pagination-success">
                  ...
                  if($page > 1){
                    ...
                    echo '
                    <li class="page-item">
                    <a class="page-link" href="'.base_url('artikel?show='.$show.'&page='.$n).'">&#10094;</a></li>
                    ';
                  }
                  if($page >= 1){
                    for ($i=1; $i <= ceil($banyakpage); $i++) { 
                      ...
                      echo '
                      <li class="page-item"><a class="page-link '.$act.'" href="'.base_url('artikel?show='.$show.'&page='.$i).'" style="'.$bg.'">'.$i.'</a></li>';
                    }
                  }
                  if($page < ceil($banyakpage)){
                    $n= $page+1;
                    echo '
                    <li class="page-item"><a class="page-link" href="'.base_url('artikel?show='.$show.'&page='.$n).'">&#10095;</a></li>
                    ';
                  }
                  ?> 
                </ul>
